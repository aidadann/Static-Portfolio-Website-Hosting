    ...
    <div className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20 pb-12 noise-overlay">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        <motion.div
          ...
          className="relative w-48 h-48 md:w-64 md:h-64 mb-12 p5-panel bg-black border-4 border-white shadow-[12px_12px_0_rgba(255,0,60,1)] flex items-center justify-center overflow-hidden"
        >
        ...
        >
          <div className="p5-panel bg-black border-4 border-white px-8 py-2 transform -skew-x-12 mb-6 shadow-[8px_8px_0_rgba(255,0,60,1)]">
            <h2 className="text-xl md:text-3xl font-black text-white uppercase tracking-[0.3em]">
          ...
          >
            <a
              ...
              className="group flex items-center gap-3 px-10 py-5 bg-accent text-white font-black uppercase tracking-[0.2em] text-xl border-4 border-white shadow-[8px_8px_0_rgba(0,0,0,1)] transform -skew-x-12 hover:bg-white hover:text-black hover:shadow-[12px_12px_0_rgba(255,0,60,1)] hover:-translate-y-1 transition-all"
            >
